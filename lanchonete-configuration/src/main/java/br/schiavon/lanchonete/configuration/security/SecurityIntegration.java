...
public class SecurityIntegration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(br.schiavon.lanchonete.configuration.security.SecurityIntegration.class);
     ...
     */
    public static final String BASE = ".*lanchonete-api.api";
