package br.schiavon.lanchonete.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.schiavon.lanchonete.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.schiavon.lanchonete");
